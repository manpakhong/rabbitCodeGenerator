	...
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message
					code="menu.administration.log.route.schedule" /></li>
		</ol>
	</section>
	<!-- Main content -->
	<section class="content">
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<form:form cssClass="form-horizontal"
						commandName="patrolScheduleActionForm" method="post"
						action="DoSearchPatrolScheduleAction.do">
						<spring:bind path="*">
						...
						<div class="box-body">
							...
							<div class="box-footer">
								...
								<div class="col-xs-2 col-lg-1 ">
									<a onclick="showLoading()" href="SearchPatrolScheduleAction.do"
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
					<c:if test="${patrolScheduleActionForm.fullListSize>0}">
...
<script>
	...
	menu_select("patrolScheduleActionLog");
</script>
...
<script type="text/javascript">
	var table = $('#example1').dataTable({
		...
		"bProcessing" : true,
		"bServerSide" : true,
		"sAjaxSource" : "DoPatrolScheduleActionDataTable.do",
		"language" : {
...
<script>
console.log(${patrolScheduleActionForm.fullListSize})
var fullListSize = ${patrolScheduleActionForm.fullListSize};
if(fullListSize>0){
