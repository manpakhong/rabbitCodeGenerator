	...
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message
					code="menu.administration.log.defect.schedule" /></li>
		</ol>
	</section>
	<!-- Main content -->
	<section class="content">
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<form:form cssClass="form-horizontal"
						commandName="defectScheduleActionForm" method="post"
						action="DoSearchDefectScheduleAction.do">
						<spring:bind path="*">
						...
						<div class="box-body">
							...
							<div class="box-footer">
								...
								<div class="col-xs-2 col-lg-1 ">
									<a onclick="showLoading()" href="SearchDefectScheduleAction.do"
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
					<c:if test="${defectScheduleActionForm.fullListSize>0}">
...
<script>
	...
	menu_select("maintenanceScheduleActionLog");
</script>
...
<script type="text/javascript">
	var table = $('#example1').dataTable({
		...
		"bProcessing" : true,
		"bServerSide" : true,
		"sAjaxSource" : "DoDefectScheduleActionDataTable.do",
		"language" : {
...
<script>
console.log(${defectScheduleActionForm.fullListSize})
var fullListSize = ${defectScheduleActionForm.fullListSize};
if(fullListSize>0){
