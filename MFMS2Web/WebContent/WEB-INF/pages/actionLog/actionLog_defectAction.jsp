	...
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message
					code="menu.administration.log.defect" /></li>
		</ol>
	</section>
	<!-- Main content -->
	<section class="content">
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<form:form cssClass="form-horizontal"
						commandName="defectActionForm" method="post"
						action="DoSearchDefectAction.do">
						<spring:bind path="*">
						...
						<div class="box-body">
							...
							<div class="box-footer">
								...
								<div class="col-xs-2 col-lg-1 ">
									<a onclick="showLoading()" href="SearchDefectAction.do"
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
					<c:if test="${defectActionForm.fullListSize>0}">
					<form:form commandName="hidden_form" cssClass="form-horizontal">
								<button class="btn btn-primary" id="btn_export" style="display:none"
...
<script type="text/javascript">
	var table = $('#example1').dataTable({
		...
		"bProcessing" : true,
		"bServerSide" : true,
		"sAjaxSource" : "DoDefectActionDataTable.do",
		"language" : {
...
<script>
console.log(${defectActionForm.fullListSize})
var fullListSize = ${defectActionForm.fullListSize};
if(fullListSize>0){
...
function exportToExcel() {
	...
	form.setAttribute("action", "ExportDefectActionLog.do");
