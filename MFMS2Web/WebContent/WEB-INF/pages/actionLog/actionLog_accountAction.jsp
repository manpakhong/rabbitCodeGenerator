	...
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message
					code="menu.administration.log.account" /></li>
		</ol>
	</section>
	<!-- Main content -->
	<section class="content">
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<form:form cssClass="form-horizontal"
						commandName="accountActionForm" method="post"
						action="DoSearchAccountAction.do">
						<spring:bind path="*">
						...
						<div class="box-body">
							...
							<div class="box-footer">
								...
								<div class="col-xs-2 col-lg-1 ">
									<a onclick="showLoading()" href="SearchAccountAction.do"
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
					<c:if test="${accountActionForm.fullListSize>0}">
...
<script type="text/javascript">
	var table = $('#example1').dataTable({
		...
		"bProcessing" : true,
		"bServerSide" : true,
		"sAjaxSource" : "DoAccountActionDataTable.do",
		"language" : {
...
console.log(${accountActionForm.fullListSize})
var fullListSize = ${accountActionForm.fullListSize};
if(fullListSize>0){
