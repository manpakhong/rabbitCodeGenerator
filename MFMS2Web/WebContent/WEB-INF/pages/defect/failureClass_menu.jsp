	...
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message
					code="menu.administration.defectMgt.failureClass" /></li>
		</ol>
	</section>
	<!-- Main content -->
		...
		<div class="row">
			...
			<c:if
				...
				<div class="col-lg-4  col-sm-6 iconStyle">
					<a href="SearchFailureClass.do">
						<div class=" well">
							<img class="img-responsive"
								src="import/img2/admin/failure_class_search.png" alt="">
							<h2 class="iconName">
								<spring:message
									code="menu.administration.defectMgt.failureClass.search" />
							</h2>
						</div>
					</a>
				</div>
			...
			<c:if
				...
				<div class="col-lg-4  col-sm-6 iconStyle">
					<a href="CreateFailureClass.do">
						<div class=" well">
							<img class="img-responsive"
								src="import/img2/admin/failure_class_create.png" alt="">
							<h2 class="iconName">
								<spring:message
									code="menu.administration.defectMgt.failureClass.create" />
							</h2>
						</div>
					</a>
				</div>
...
<script>
	...
	menu_toggle("sub_admin_failureclass", 1);
</script>
