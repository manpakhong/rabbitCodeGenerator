	...
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message
					code="menu.administration.defectMgt.failureClass.search" /></li>
		</ol>
	</section>
	<!-- Main content -->
	<section class="content">
				...
				<div class="col-xs-12">
					...
					<div class="box">
						...
						<form:form cssClass="form-horizontal"
							commandName="searchFailureClassForm" method="post"
							action="DoSearchFailureClass.do">
							<form:hidden path="siteKey" />
							<c:if test="${searchFailureClassForm.deleteSuccess}">
								<div class="form-group alert alert-success">
									<spring:message code="failureClass.delete.success"
										arguments="${searchFailureClassForm.deletedName}" />
								</div>
							</c:if>
							<c:if test="${searchFailureClassForm.hasChild}">
								<div class="form-group alert alert-danger">
									<spring:message code="failureClass.hasChild"
										arguments="${searchFailureClassForm.deletedName}" />
								</div>
							</c:if>
							<input type="hidden" name="deleteSuccess" value="false" />
							<input type="hidden" name="hasChild" value="false" />
							<div class="box-body">
								<div class="form-group">
									<label for="" class="col-sm-2 control-label"><spring:message
											code="failureClass.code" /></label>
									<div class="col-sm-4">
										<spring:message code="failureClass.code"
											var="failureClassCode" />
										<form:input path="code" cssClass="form-control"
											placeholder="${failureClassCode}" />
									</div>
									<label for="" class="col-sm-2 control-label"><spring:message
											code="failureClass.name" /></label>
									<div class="col-sm-4">
										<spring:message code="failureClass.name"
											var="failureClassName" />
										<form:input path="name" cssClass="form-control"
											placeholder="${failureClassName}" />
									</div>
								...
								<div class="box-footer">
									<div class="col-xs-2 col-xs-offset-8 col-lg-offset-10 col-lg-1">
										...
										<div class="col-xs-2 col-lg-1">
											<a onclick="showLoading()" href="SearchFailureClass.do" class="btn btn-primary "><spring:message
													code="button.reset" /></a>
										</div>
			...
			<div class="row  pull-right">
				<div class="col-xs-12 ">
					...
					<c:if
						test="${currRole.grantedPrivilegeCodeList.contains(viewFailureClass)}">
					...
					<c:if
						test="${currRole.grantedPrivilegeCodeList.contains(removeFailureClass)}">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
						<div class="box-body">
						<c:if test="${searchFailureClassForm.fullListSize>0}">
								...
								<thead>
									<tr>
										...
										<th width="20%" style="word-wrap: break-word;"><spring:message
												code="failureClass.code" /></th>
										<th width="30%" style="word-wrap: break-word;"><spring:message
												code="failureClass.name" /></th>
										<th><spring:message code="failureClass.description" /></th>
									</tr>
								</thead>
							</table>
						</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<spring:message code="failureClass.confirm.delete" />
				</h4>
			</div>
			<div class="modal-body">
				<p>
					<spring:message code="failureClass.confirm.delete.message" />
				</p>
				<br />
				<p id="confirmName"></p>
			</div>
...
function showDelete(key, code) {
	...
	// put link on modal
	$('#confirmButton').attr('href', 'DoDeleteFailureClass.do?key=' + key);
	// put name on modal
...
var table = $('#example1').dataTable({
	...
	"bProcessing" : true,
	"bServerSide" : true,
	"sAjaxSource" : "DoFailureClassDataTable.do",
	"language" : {
...
<script>
console.log(${searchFailureClassForm.fullListSize})
var fullListSize = ${searchFailureClassForm.fullListSize};
if(fullListSize>0){
...
function exportToExcel() {
	...
	form.setAttribute("action", "ExportFailureClass.do");
