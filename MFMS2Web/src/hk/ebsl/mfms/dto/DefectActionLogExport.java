...
public class DefectActionLogExport {
	private String date;
	...
	private String issureBy;
	
	private String issueDateTime;
	
	private String targetStartDateTime;
	
	private String targetAttendDateTime;
	...
	public String getIssureBy() {
		return issureBy;
	}

	public void setIssureBy(String issureBy) {
		this.issureBy = issureBy;
	}
	...
	public String getTargetAttendDateTime() {
		return targetAttendDateTime;
	}

	public void setTargetAttendDateTime(String targetAttendDateTime) {
